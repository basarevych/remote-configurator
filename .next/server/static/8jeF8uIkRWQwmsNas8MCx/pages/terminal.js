...
Object.defineProperty(exports, "default", {
  enumerable: true,
  get: function get() {
    return _TerminalPage.default;
  }
});

var _TerminalPage = _interopRequireDefault(__webpack_require__(179));
...
var _TerminalPage = _interopRequireDefault(__webpack_require__(180));
...
var TerminalPage = (0, _reactRedux.connect)(mapStateToProps, null, null, {
  pure: false
})(_TerminalPage.default);

TerminalPage.getInitialProps =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
...
var _Terminal = _interopRequireDefault(__webpack_require__(181));
...
function (_React$Component) {
  ...
  _createClass(TerminalPage, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_Terminal.default, {
...
var _Terminal = _interopRequireDefault(__webpack_require__(182));
...
var mapStateToProps = function mapStateToProps(state, props) {
  return {
    isConnected: _terminals.terminalsSelectors.hasTerminal(state, props),
    name: _terminals.terminalsSelectors.getTerminalName(state, props),
    address: _terminals.terminalsSelectors.getTerminalAddress(state, props),
    history: _histories.historiesSelectors.getList(state, props) || (0, _immutable.List)([])
  };
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
  return {
    onInput: function onInput(data) {
      return dispatch(_terminals.terminalsOperations.sendInput({
        terminalId: props.terminalId,
        data: data
      }));
    },
    onResize: function onResize(cols, rows, width, height) {
      return dispatch(_terminals.terminalsOperations.sendResize({
        terminalId: props.terminalId,
        cols: cols,
        rows: rows,
        width: width,
    ...
    onClose: function onClose() {
      return dispatch(_terminals.terminalsOperations.kill({
        terminalId: props.terminalId
      }));
    }
  };
...
var Terminal = (0, _router.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Terminal.default));
...
var _reactVirtualized = __webpack_require__(183);

var _reactIntl = __webpack_require__(9);

var _styles = __webpack_require__(11);

var _IconButton = _interopRequireDefault(__webpack_require__(101));

var _Close = _interopRequireDefault(__webpack_require__(184));

var _Paper = _interopRequireDefault(__webpack_require__(185));

var _Typography = _interopRequireDefault(__webpack_require__(186));

var _XTerm = _interopRequireDefault(__webpack_require__(187));

var _grey = _interopRequireDefault(__webpack_require__(192));

var _blue = _interopRequireDefault(__webpack_require__(193));

var _cyan = _interopRequireDefault(__webpack_require__(194));

var _green = _interopRequireDefault(__webpack_require__(195));

var _pink = _interopRequireDefault(__webpack_require__(196));

var _red = _interopRequireDefault(__webpack_require__(103));

var _yellow = _interopRequireDefault(__webpack_require__(197));
...
var _xterm = __webpack_require__(188);

var fit = _interopRequireWildcard(__webpack_require__(189));

var fullscreen = _interopRequireWildcard(__webpack_require__(190));

var search = _interopRequireWildcard(__webpack_require__(191));
