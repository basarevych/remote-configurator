...
_TerminalPage.default.getInitialProps =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
...
var _default = _TerminalPage.default;
exports.default = _default;
...
var mapStateToProps = function mapStateToProps(state, props) {
  var terminal = _terminals.terminalsSelectors.getTerminalMap(state, props);
  ...
  return {
    ...
    history: terminal ? _histories.historiesSelectors.getList(state, props) || (0, _immutable.List)([]) : (0, _immutable.List)([])
  };
};
...
var _IconButton = _interopRequireDefault(__webpack_require__(108));
...
var _red = _interopRequireDefault(__webpack_require__(110));
...
function (_React$Component) {
  ...
  _createClass(Terminal, [{
    ...
    value: function renderPlaceholder() {
      ...
      }, this.state.status && _react.default.createElement("h3", null, this.state.status), !this.state.status && (this.props.isConnecting ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_CircularProgress.default, {
        color: "primary",
        size: 60
        ...
        return _react.default.createElement(_XTerm.default, {
          ...
          options: {
            ...
            theme: {
              ...
              black: "#000000",
              blue: _blue.default[400],
              cyan: _cyan.default[400],
              green: _green.default[400],
              magenta: _pink.default[400],
              red: _red.default[400],
              yellow: _yellow.default[400],
              white: _grey.default[100],
              brightBlack: _grey.default[700],
              brightBlue: _blue.default[100],
              brightCyan: _cyan.default[100],
              brightGreen: _green.default[100],
              brightMagenta: _pink.default[100],
              brightRed: _red.default[100],
              brightYellow: _yellow.default[100],
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      var state = {};
      if (nextProps.status && prevState.status !== nextProps.status) state.status = nextProps.status;
