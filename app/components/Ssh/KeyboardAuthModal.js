...
class KeyboardAuthModal extends Form {
  static propTypes = {
    ...Form.propTypes,
    intl: intlShape,
  ...
  static formName = "keyboardAuthForm";
  ...
  render() {
    return (
      ...
      >
        <DialogTitle>
          <FormattedMessage id="KEYBOARD_AUTH_TITLE" />
        </DialogTitle>
        {this.props.banner && (
          <DialogContent>
            <DialogContentText>{this.props.banner}</DialogContentText>
          </DialogContent>
        )}
        <DialogContent>
          {_.map(this.props.prompts, (item, index) => (
...
export default withStyles(styles, { withTheme: true })(KeyboardAuthModal);
