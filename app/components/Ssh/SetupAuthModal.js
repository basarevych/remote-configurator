...
class SetupAuthModal extends Form {
  static propTypes = {
    ...Form.propTypes,
    intl: intlShape,
  ...
  render() {
    return (
      <Dialog maxWidth="xs" fullWidth open={this.props.isOpen} onClose={_.noop}>
        <DialogTitle>
          <FormattedMessage id="SETUP_AUTH_TITLE" />
        </DialogTitle>
        <DialogContent>
          <Grid
            container
...
export default withStyles(styles, { withTheme: true })(SetupAuthModal);
